  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background hover:bg-accent hover:text-accent-foreground hover:shadow-sm active:bg-accent/90",
        secondary:
        ...
        success: "bg-success text-success-foreground hover:bg-success/90 hover:shadow-md active:bg-success/95",
        warning: "bg-warning text-warning-foreground hover:bg-warning/90 hover:shadow-md active:bg-warning/95",
      },
      size: {
